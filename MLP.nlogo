...
to training
  ...
  r:eval "dataset <- read.csv('/home/luis/Dropbox/Research Project/code/agents-code/dataset-3000.csv', header=TRUE, sep=delim)"
  ...
  r:eval "model <- mlp(dataset$inputsTrain, dataset$targetsTrain, size=c(35), maxit=3000, learnFunc='Rprop', linOut=TRUE)"
