...
to training
  ...
  r:eval "model <- rbf(dataset$inputsTrain, dataset$targetsTrain, size=c(17), maxit = 2000, initFunc='RBF_Weights', initFuncParams = c(0.5, 1, 0, 0.02, 0.04),learnFunc='RadialBasisLearning', updateFunc = 'Topological_Order', learnFuncParams=c(1e-8, 0, 1e-8, 1, 0.8), linOut=TRUE, inputsTest = dataset$inputsTest, targetsTest = dataset$targetsTest)"
end
